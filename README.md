...
- Configure a custom release+deploy strategy (would allow to target all kinds of applications, even not elixir ones. Some of `Config` would be part of this behaviour, can override default controller)
