...
[![Hexdocs.pm](https://img.shields.io/badge/api-hexdocs-brightgreen.svg)](https://hexdocs.pm/deli/0.2.0-rc.4)
...
Checkout [Release configuration](https://hexdocs.pm/deli/0.2.0-rc.4/release.html#release-configuration) for more options.
